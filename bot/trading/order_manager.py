...
from bot.exchange.client import MexcClient, InsufficientBalance, InvalidApiKey, NetworkError, MexcError
...
class OrderManager:
    ...
    async def check_sell_fills(
        ...
        except (InvalidApiKey, NetworkError):
            raise  # Let engine handle auth/network failures
        except MexcError as e:
